...
class MyApp(Tk):
    ...
    def setupUI(self):
        ...
        b1=Checkbutton(group,text=self.items[0],variable=self.items_v[-1],indicatoron=FALSE,command = self.checkB1,bd=3,padx=35,bg='#32CD32',fg='#A52A2A')
        b1.grid(row=0,column=0,sticky=E+W,padx=0,pady=3,)
        self.items_v.append(IntVar())
        b2=Checkbutton(group,text=self.items[1],variable=self.items_v[-1],indicatoron=FALSE,command = self.checkB2,bd=3,padx=35,bg='#32CD32',fg='#A52A2A')
        b2.grid(row=1,column=0,sticky=W+E,padx=0,pady=3,)
        self.items_v.append(IntVar())
        b3=Checkbutton(group,text=self.items[2],variable=self.items_v[-1],indicatoron=FALSE,command = self.checkB3,bd=3,padx=35,bg='#32CD32',fg='#A52A2A')
        b3.grid(row=2,column=0,sticky=W+E,padx=0,pady=3,)
        self.items_v.append(IntVar())
        b4=Checkbutton(group,text=self.items[3],variable=self.items_v[-1],indicatoron=FALSE,command = self.checkB4,bd=3,padx=35,bg='#32CD32',fg='#A52A2A')
        b4.grid(row=3,column=0,sticky=W+E,padx=0,pady=3,)
        self.items_v.append(IntVar())
        b5=Checkbutton(group,text=self.items[4],variable=self.items_v[-1],indicatoron=FALSE,command = self.checkB5,bd=3,padx=35,bg='#32CD32',fg='#A52A2A')
